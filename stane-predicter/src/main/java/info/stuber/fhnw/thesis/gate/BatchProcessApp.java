 ...
 * results are written out to XML files, either in GateXML format (all
...
public class BatchProcessApp {
	...
	public static void main(String[] args) throws Exception {
		...
		// gappFile = new File("C:/Program Files/GATE_Developer_8.2/plugins/ANNIE/ANNIE_with_defaults.gapp");
