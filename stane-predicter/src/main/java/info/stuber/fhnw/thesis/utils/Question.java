...
public class Question {
	...
	private static void initQuestions() {
		...
		questions.put(3, "All citizens should be entitled to a minimum guaranteed income.");
		...
		questions.put(12, "The government should loosen planning restrictions to encourage house-building.");
		...
		questions.put(16, "Doctors should be allowed to help terminally ill patients to die if they so wish.");
		...
		questions.put(24, "The United Kingdom should take a tougher line over Russian involvement in Ukraine.");
		...
		questions.put(28, "The United Kingdom should welcome a larger number of asylum seekers from war-torn countries.");
		...
		questions.put(35, "Scotland should be an independent country.");
		questions.put(36, "Full tax-raising powers should be granted to the Scottish parliament.");
		questions.put(37, "More powers should be devolved to the Welsh government.");
